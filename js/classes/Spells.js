...
// Freeze
var freeze = Attack.extend({ init: function(){ this._super("Freeze", "freeze", "1d6", "ice", 4, 2); } });

// Lighting
var lightning = Attack.extend({ init: function(){ this._super("Lightning", "lightning", "1d4", "energy", 4, 3); } });
